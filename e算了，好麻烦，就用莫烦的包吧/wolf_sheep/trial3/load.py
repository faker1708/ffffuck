...
#y
    ...
    def main(g):
        show_game = 1
        plt_on = 1-show_game  # 是否显示图表

        train = 0

        print('load')

        # file_path = './model/512_0.393140969954323.pkl'
        # file_path = './model/1280_0.2635119929707123.pkl'
        file_path = './model/2816_0.4542237830602283.pkl'
        
        
        
        wolf_dqn = g.load(file_path)
        wolf_dqn.epsilon = 0.5
